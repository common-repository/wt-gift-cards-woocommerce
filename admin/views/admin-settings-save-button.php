...
$settings_button_title = isset( $settings_button_title ) && '' !== $settings_button_title ? $settings_button_title : __( 'Save settings', 'wt-gift-cards-woocommerce' );
...
<div class="wt-gc-plugin-toolbar bottom">
	...
	<div class="right">
		<input type="submit" name="wt_gc_update_admin_settings_form" value="<?php echo esc_attr( $settings_button_title ); ?>" class="button button-primary" style="float:right;"/>
